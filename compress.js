function adapter() {
    ...
    try {
        console.warn('couldn\'t find native brotli support in zlib library. trying to fall back to iltorb.');
        var iltorb = require('iltorb');
        return iltorb.compress;
    } catch (err) {
        console.warn('couldn\'t load iltorb library. trying to fall back to brotli.js.');
        console.warn(err);
